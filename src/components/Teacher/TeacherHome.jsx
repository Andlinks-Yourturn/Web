...
import { fetchStudentList } from '../../services/teacher';
...
export default class TeacherHome extends Component {
    ...
    successCallback(result) {
        return (addUp) => {
            ...
            if(result.totalPages > 1) {
                ...
                if(result.totalPages === this.current + 1) {
                    morePage = false;
                }
                this.state.pageInfo = {
                    morePage: morePage,
    ...
    getStudentListByPage(param, addUp, successCb, errorCb) {
        fetchStudentList(param).then((res) => {
        ...
        return <Frame headerTitle="Main Page" iconClass="icon-homepage">
            <div className="teacher-home">
                ...
                <div className="content-body">
                    ...
                    {/* 学生列表*/}
                    <Panel header="My Student List" className="student-info">
